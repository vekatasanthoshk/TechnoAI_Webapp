...
function Field({
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-[#3a4a7a] mb-1.5">{label} *</label>
      {children}
...
const inputErrCls = "w-full px-4 py-2.5 bg-[#fff0f0] border border-red-300 rounded-lg focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-400 text-[#0d1b3e] placeholder:text-[#8a9abf] text-sm transition-colors";
...
export default function Home() {
  ...
  const modalForm = useForm<ContactFormData>({
    resolver: zodResolver(contactSchema),
    defaultValues: { name: "", email: "", company: "", message: "" },
  });

  const onSubmit = async (data: ContactFormData, reset: () => void, closeModal?: () => void) => {
    try {
  ...
  const services = [
    { icon: <Zap className="w-7 h-7" />, title: "Business Automation", description: "Streamline workflows and eliminate manual processes with intelligent automation that scales with your business.", color: "from-blue-500 to-blue-700" },
    { icon: <Brain className="w-7 h-7" />, title: "Custom AI Agents", description: "Deploy specialized AI agents for sales, marketing, support, and operations — trained on your business data.", color: "from-teal-400 to-cyan-600" },
    { icon: <Code className="w-7 h-7" />, title: "Data Decision Systems", description: "Build intelligent systems that transform raw data into actionable insights and competitive advantages.", color: "from-green-400 to-emerald-600" },
  ];

  const metrics = [
    { value: "85%", label: "Increase in Leads", color: "text-blue-500" },
    { value: "40%", label: "Cost Reduction", color: "text-teal-500" },
    { value: "3.2x", label: "ROI Improvement", color: "text-green-500" },
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-[#0d1b3e]">
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-[rgba(41,98,255,0.12)] shadow-sm z-50">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-7 text-sm text-[#3a4a7a]">
            {navItems.map((item) => (
              <button key={item.label} onClick={() => scrollToSection(item.href)} className="hover:text-[#2962FF] transition-colors">{item.label}</button>
            ))}
          </div>
          <div className="hidden md:flex gap-3">
            <Button variant="outline" size="sm" className="border-[rgba(41,98,255,0.35)] text-[#3a4a7a] hover:border-[#2962FF] hover:text-[#2962FF] bg-transparent" onClick={() => scrollToSection("#contact")}>Contact</Button>
            <Button size="sm" className="brand-gradient text-white hover:opacity-90 border-0" onClick={() => setContactFormOpen(true)}>Book Consultation</Button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-b border-[rgba(41,98,255,0.12)] shadow-sm">
            <div className="container py-4 flex flex-col gap-4">
              {navItems.map((item) => (
                <button key={item.label} onClick={() => scrollToSection(item.href)} className="text-left text-sm text-[#3a4a7a] hover:text-[#2962FF] transition-colors">{item.label}</button>
              ))}
              <Button size="sm" className="brand-gradient text-white border-0 w-full" onClick={() => setContactFormOpen(true)}>Book Consultation</Button>
            </div>
          </div>
        )}
      </nav>
      ...
      <section id="services" className="py-20 bg-[#f8faff]">
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="text-[#4a5a8a] max-w-2xl mx-auto">Comprehensive AI solutions designed to drive growth and efficiency across your entire organization.</p>
          </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Digital Marketing: Optimized Campaigns & ROI</h2>
            <p className="text-white/80 text-lg mb-10">Outcome-focused strategies with custom-built AI agents and data-driven optimization.</p>
            ...
            <div className="card-hover bg-white border border-[rgba(41,98,255,0.15)] rounded-xl p-8 shadow-sm">
              ...
              <div className="space-y-5">
                {[
                  ...
                  { label: "ROI Improvement", value: "3.2x", color: "text-green-500" },
                ].map((item) => (
                  <div key={item.label}>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#4a5a8a] mb-4 leading-relaxed">We are a team of AI specialists, engineers, and business strategists dedicated to transforming enterprises through intelligent automation and data-driven solutions.</p>
              <p className="text-[#4a5a8a] mb-8 leading-relaxed">With deep expertise in machine learning, natural language processing, and enterprise software, we deliver solutions that create measurable impact on your bottom line.</p>
              <div className="space-y-5">
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-4">
                    <div className="p-2 rounded-lg bg-[rgba(41,98,255,0.08)] text-[#2962FF] flex-shrink-0 mt-0.5">{item.icon}</div>
                    <div>
            ...
            <div className="bg-gradient-to-br from-[rgba(41,98,255,0.06)] to-[rgba(0,200,179,0.04)] border border-[rgba(41,98,255,0.12)] rounded-2xl p-10 flex flex-col items-center justify-center min-h-80 text-center">
              <TechnoAILogo size={112} className="mx-auto mb-5" />
              <p className="font-bold text-lg text-[#0d1b3e]">KVS TechnoAI LLC</p>
              <p className="text-[#5a6a9a] text-sm mt-1">Business Automation & AI Solutions</p>
              <div className="flex gap-3 mt-6">
                <span className="px-3 py-1 rounded-full bg-[rgba(41,98,255,0.08)] text-[#2962FF] text-xs border border-[rgba(41,98,255,0.2)]">AI Automation</span>
                <span className="px-3 py-1 rounded-full bg-[rgba(0,200,179,0.08)] text-[#00C8B3] text-xs border border-[rgba(0,200,179,0.2)]">ML & NLP</span>
                <span className="px-3 py-1 rounded-full bg-[rgba(0,203,83,0.08)] text-[#00CB53] text-xs border border-[rgba(0,203,83,0.2)]">Growth</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="ecommerce" className="py-20 bg-[#f8faff]">
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="text-[#4a5a8a] max-w-2xl mx-auto">Omnichannel platform capabilities for custom growth, ROI, and business scalability.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="card-hover bg-white border border-[rgba(41,98,255,0.15)] rounded-xl p-8 shadow-sm">
              <h3 className="text-xl font-bold mb-6">Growth & Automation Features</h3>
              <ul className="space-y-4">
                {["Intelligent product recommendations","Automated customer segmentation","Dynamic pricing optimization","Predictive inventory management","AI-powered ad campaign optimization"].map((item) => (
            ...
            <div className="card-hover bg-white border border-[rgba(41,98,255,0.15)] rounded-xl p-8 shadow-sm">
              ...
              <div className="space-y-6">
                {[
                  { value: "85%", label: "Increase in Leads", color: "text-blue-500", bar: "bg-blue-500", pct: "85%" },
                  { value: "40%", label: "Reduction in Op-Ex", color: "text-teal-500", bar: "bg-teal-400", pct: "40%" },
                  { value: "+3.2x", label: "ROI on Ad Spend", color: "text-green-500", bar: "bg-green-400", pct: "80%" },
                ].map((item) => (
                  <div key={item.label}>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[#3a4a7a] text-sm">{item.label}</span>
                    ...
                    <div className="h-1.5 bg-[rgba(41,98,255,0.1)] rounded-full overflow-hidden">
      ...
      {/* CONTACT SECTION — react-hook-form */}
      <section id="contact" className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-[#4a5a8a] max-w-2xl mx-auto">Contact us today for a free consultation and discover how AI can drive your growth.</p>
          </div>
          <div className="max-w-2xl mx-auto">
            <div className="bg-white border border-[rgba(41,98,255,0.15)] rounded-2xl p-8 shadow-md">
              <form onSubmit={sectionForm.handleSubmit((data) => onSubmit(data, sectionForm.reset))} className="space-y-5" noValidate>
                <div className="grid sm:grid-cols-2 gap-5">
                  <Field label="Name" error={sectionForm.formState.errors.name?.message}>
                    <input {...sectionForm.register("name")} type="text" placeholder="Your name"
                      className={sectionForm.formState.errors.name ? inputErrCls : inputCls} />
                  </Field>
                  <Field label="Email" error={sectionForm.formState.errors.email?.message}>
                    <input {...sectionForm.register("email")} type="email" placeholder="you@company.com"
                      className={sectionForm.formState.errors.email ? inputErrCls : inputCls} />
                  </Field>
                </div>
                <Field label="Company" error={sectionForm.formState.errors.company?.message}>
                  <input {...sectionForm.register("company")} type="text" placeholder="Your company name"
                    className={sectionForm.formState.errors.company ? inputErrCls : inputCls} />
                </Field>
                <Field label="Message" error={sectionForm.formState.errors.message?.message}>
                  <textarea {...sectionForm.register("message")} rows={5} placeholder="Tell us about your project and goals..."
                    className={`${sectionForm.formState.errors.message ? inputErrCls : inputCls} resize-none`} />
                </Field>
                <Button type="submit" size="lg" className="w-full brand-gradient text-white border-0 hover:opacity-90 glow-blue"
                  disabled={sectionForm.formState.isSubmitting || contactMutation.isPending}>
                  {sectionForm.formState.isSubmitting || contactMutation.isPending ? "Sending..." : "Send Message"}
                </Button>
              </form>
            </div>
          </div>
        ...
        <div className="container">
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-[#5a6a9a]">Business Automation & AI Solutions</p>
            </div>
            <div>
              <h4 className="font-semibold text-sm text-[#0d1b3e] mb-4">Services</h4>
              <ul className="space-y-2 text-sm text-[#5a6a9a]">
          ...
          <div className="border-t border-[rgba(41,98,255,0.15)] pt-8 text-center text-sm text-[#5a6a9a]">
            <p>&copy; 2025 KVS TechnoAI LLC. All rights reserved.</p>
          </div>
        </div>
      </footer>

      {/* MODAL — react-hook-form */}
      {contactFormOpen && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-[rgba(41,98,255,0.2)] rounded-2xl max-w-md w-full p-7 relative shadow-2xl">
            <button onClick={() => { setContactFormOpen(false); modalForm.reset(); }}
            ...
            <form onSubmit={modalForm.handleSubmit((data) => onSubmit(data, modalForm.reset, () => setContactFormOpen(false)))} className="space-y-4" noValidate>
              <Field label="Name" error={modalForm.formState.errors.name?.message}>
                <input {...modalForm.register("name")} type="text" placeholder="Your name"
                  className={modalForm.formState.errors.name ? inputErrCls : inputCls} />
              </Field>
              <Field label="Email" error={modalForm.formState.errors.email?.message}>
                <input {...modalForm.register("email")} type="email" placeholder="you@company.com"
                  className={modalForm.formState.errors.email ? inputErrCls : inputCls} />
              </Field>
              <Field label="Company" error={modalForm.formState.errors.company?.message}>
                <input {...modalForm.register("company")} type="text" placeholder="Your company"
                  className={modalForm.formState.errors.company ? inputErrCls : inputCls} />
              </Field>
              <Field label="Message" error={modalForm.formState.errors.message?.message}>
                <textarea {...modalForm.register("message")} rows={4} placeholder="Tell us about your project..."
                  className={`${modalForm.formState.errors.message ? inputErrCls : inputCls} resize-none`} />
              </Field>
              <Button type="submit" size="lg" className="w-full brand-gradient text-white border-0 hover:opacity-90"
                disabled={modalForm.formState.isSubmitting || contactMutation.isPending}>
                {modalForm.formState.isSubmitting || contactMutation.isPending ? "Sending..." : "Send Message"}
              </Button>
            </form>
          </div>
        </div>
